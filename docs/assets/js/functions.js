  ...
  guestSelector: function () {
    if (e.isVariableDefined(e.select(".guest-selector"))) {
      ...
      function showElements() {
        ...
        let resultText =
          totalAdults + " " + guestText + " " + rooms + " " + roomText;
  ...
  rangeSlider: function () {
    ...
    if (e.isVariableDefined(rangeSlider)) {
      ...
      rangeSliders.forEach((slider) => {
        ...
        var nouiSelectedMin = parseInt(
          slider.getAttribute("data-range-selected-min")
        );
        var nouiSelectedMax = parseInt(
          slider.getAttribute("data-range-selected-max")
        );
