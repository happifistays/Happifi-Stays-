...
const TopNavBar8 = () => {
  ...
  return <header className={clsx('header-sticky', {
    'header-sticky-on': scrollY >= 400
  })}>
      <Navbar expand="xl" className="navbar-light-static">
        <Container fluid className="px-md-5">
          <LogoBox />
          <button onClick={toggle} className="navbar-toggler ms-auto me-3 p-0" type="button" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded={isOpen} data-bs-toggle="collapse" aria-label="Toggle navigation">
