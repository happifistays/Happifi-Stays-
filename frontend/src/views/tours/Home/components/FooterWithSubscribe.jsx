...
const apps = [FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn, FaGithub];
        ...
        <div className="bg-light rounded-top p-4 pb-0">
          <Row className="g-4 justify-content-between">
            <Col md={5} lg={4}>
              ...
              <p className="text-reset mt-4 mb-2">
                Subscribe to Our Newsletter
              </p>
              <form
                onSubmit={handleSubmit(() => {})}
                className="bg-body rounded-2 p-2"
              >
                <div className="input-group">
                  ...
                  <Button
                    variant="dark"
                    type="submit"
                    className="rounded-2 mb-0 flex-centered"
                  >
                    <BsSend />
                  </Button>
                </div>
