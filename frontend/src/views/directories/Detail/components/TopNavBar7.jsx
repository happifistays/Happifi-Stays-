...
import { Card, CardBody, CardFooter, CardHeader, Container, Dropdown, DropdownDivider, DropdownItem, DropdownMenu, DropdownToggle, ListGroup, ListGroupItem, Nav, Navbar, OverlayTrigger, Tooltip } from 'react-bootstrap';
...
const TopNavBar7 = () => {
  ...
  return <Navbar expand="xl" className="navbar-light">
      <Container>
        <LogoBox />
