          ...
          <Col lg={6} className="mx-auto text-center">
            ...
            <ul className="list-inline mt-3 mb-0">
              <li className="list-inline-item mx-2">
                <Link
                  className="btn btn-white btn-sm shadow px-2 text-facebook flex-centered py-2"
                  to=""
                >
                  <FaFacebookF />
                </Link>
              ...
              <li className="list-inline-item mx-2">
                <Link
                  className="btn btn-white btn-sm shadow px-2 text-instagram flex-centered py-2"
                  to=""
                >
                  <FaInstagram />
                </Link>
              ...
              <li className="list-inline-item mx-2">
                <Link
                  className="btn btn-white btn-sm shadow px-2 text-twitter flex-centered py-2"
                  to=""
                >
                  <FaTwitter />
                </Link>
              ...
              <li className="list-inline-item mx-2">
                <Link
                  className="btn btn-white btn-sm shadow px-2 text-linkedin flex-centered py-2"
                  to=""
                >
                  <FaLinkedinIn />
                </Link>
