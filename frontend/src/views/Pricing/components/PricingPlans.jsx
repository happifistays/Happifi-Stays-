...
const PricingPlans = () => {
  ...
  return <section className="price-wrap pt-4 pt-sm-0">
      <Container>
        <Row>
                ...
                <Card className={`${plan.planName == 'Professional' ? 'border border-primary' : 'shadow'}`}>
                  <CardHeader className="d-flex justify-content-between align-items-center border-bottom p-4">
                    ...
                    <OverlayTrigger placement="top" overlay={<Tooltip>Most Popular</Tooltip>}>
                      <span className={clsx('icon-lg rounded-circle', plan.planName == 'Professional' ? 'bg-primary bg-opacity-10 text-primary' : 'bg-light')}>
                  ...
                  <CardBody className="p-4">
                    ...
                    return <li key={idx} className="mb-2 items-center">
