...
const TopNavBar4 = () => {
  ...
  return <header className={clsx('navbar-light header-sticky', {
    ...
    <Navbar expand="xl">
      <Container>
        <LogoBox />
        <button onClick={toggle} className="navbar-toggler ms-auto mx-3 p-0 p-sm-2" type="button" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded={isOpen} data-bs-toggle="collapse" aria-label="Toggle navigation">
