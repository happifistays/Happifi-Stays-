        ...
        return <Fragment key={idx}>
              <Row className="row-cols-xl-7 align-items-lg-center border-bottom g-4 px-2 py-4">
                ...
                <Col>
                  ...
                  <div className={clsx('badge bg-opacity-10', item.payment == 'Half payment' ? 'bg-info text-info' : item.payment == 'On Property' ? 'text-warning bg-warning' : 'text-success bg-success')}>
                    {item.payment}
                  </div>
                </Col>
                <Col>
              ...
              {idx == 1 && <Row className="row-cols-xl-7 align-items-lg-center border-bottom g-4">
