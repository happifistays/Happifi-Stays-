  ...
  return <div>
      ...
      'header-sticky-on': scrollY >= 400
        ...
        <Navbar expand="xl">
          <Container>
            <LogoBox />
            <button onClick={toggle} className="navbar-toggler ms-auto mx-3 me-xl-0 p-0 p-sm-1" type="button" aria-controls="navbarCollapse" data-bs-toggle="collapse" aria-expanded={isOpen} aria-label="Toggle navigation">
