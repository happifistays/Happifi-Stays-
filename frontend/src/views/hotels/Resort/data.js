...
const testimonialReviewSlides = [{
  name: 'Lori Stevens',
  avatar: avatar9,
  description: 'Moonlight newspaper up its enjoyment agreeable depending. Timed voice share led him to widen noisy young. At weddings believed in laughing'
}, {
  name: 'Carolyn Ortiz',
  avatar: avatar5,
