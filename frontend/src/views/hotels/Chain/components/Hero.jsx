                ...
                >
                  ...
                  <div className="card-img-overlay d-flex align-items-center">
                    <div className="container">
                      <Col
                        lg={6}
                        className="position-relative mb-4 mb-md-0 mx-auto mx-lg-0 text-center text-lg-start"
                      >
                        <h1 className="mb-4 mt-md-5 display-5 text-white">
                          Find the top
                          <br />
                        ...
                        <div className="hstack gap-4 flex-wrap align-items-center justify-content-center justify-content-lg-start">
                          <a href="/hotels/grid">
