              ...
              <div className="px-4 px-md-5">
                <Row className="justify-content-between align-items-center">
                  <Col md={6} lg={5} className="position-relative">
                    ...
                    <img src="https://res.cloudinary.com/djnaor5ed/image/upload/v1771746044/Review_1_xusrhq.webp" className="rounded-3 position-relative" />
                  </Col>
                  <Col md={6} lg={6}>
                    ...
                    <h5 className="fw-light">
                      Calm surroundings and warm hospitality made our family trip truly memorable. Booking was simple and confirmation came instantly without any confusion. Rooms were neat, spacious, and maintained very professionally.
                    </h5>
                    ...
                    <h6 className="mb-0">Arjun Nair</h6>
                    <span>IT Professional, Kochi</span>
                  </Col>
                </Row>
              </div>
              <div className="px-4 px-md-5">
                <Row className="justify-content-between align-items-center">
                  <Col md={6} lg={5} className="position-relative">
                    ...
                    <img src="https://res.cloudinary.com/djnaor5ed/image/upload/v1771746285/Review_-5_sdks8s.webp" className="rounded-3 position-relative" />
                  </Col>
                  <Col md={6} lg={6}>
                    <span className="display-3 mb-0 text-primary">
                      <BsQuote />
                    ...
                    <h5 className="fw-light">
                      Beautiful ambience with peaceful atmosphere perfect for a weekend getaway. Staff were polite and always ready to help with a smile. The entire stay felt comfortable, safe, and well organized.
                    </h5>
                    <ul className="list-inline small mb-2">
                      <li className="list-inline-item me-0">
                        <FaStar className="text-warning" />
              ...
              <div className="px-4 px-md-5">
                <Row className="justify-content-between align-items-center">
                  <Col md={6} lg={5} className="position-relative">
                    ...
                    <img src="https://res.cloudinary.com/djnaor5ed/image/upload/v1771746044/Review_-2_1_d0rzxw.webp" className="rounded-3 position-relative" />
                  </Col>
                  <Col md={6} lg={6}>
                    <span className="display-3 mb-0 text-primary">
                      <BsQuote />
                    ...
                    <h5 className="fw-light">
                      Smooth check-in process and excellent service from start to finish. Clean rooms, tasty breakfast, and good facilities added great value. Definitely one of the best stays we have experienced in Kerala.
                    </h5>
                    <ul className="list-inline small mb-2">
                      <li className="list-inline-item me-0">
                        <FaStar className="text-warning" />
                    ...
                    <h6 className="mb-0">Rahul Krishnan</h6>
                    <span>Business Consultant, Kozhikode</span>
                  </Col>
                </Row>
              </div>
              ...
              <div className="px-4 px-md-5">
                <Row className="justify-content-between align-items-center">
                  <Col md={6} lg={5} className="position-relative">
                    ...
                    <img src="https://res.cloudinary.com/djnaor5ed/image/upload/v1771746044/girl-review_rombce.webp" className="rounded-3 position-relative" />
                  </Col>
                  <Col md={6} lg={6}>
                    <span className="display-3 mb-0 text-primary">
                      <BsQuote />
                    ...
                    <h5 className="fw-light">
                      Loved the calm environment and professional hospitality throughout our visit. Online booking was quick and hassle-free without any delays. Highly recommended for families, couples, and business travelers.
                    </h5>
                    <ul className="list-inline small mb-2">
                      <li className="list-inline-item me-0">
                        <FaStar className="text-warning" />
                    ...
                    <h6 className="mb-0">Divya Suresh</h6>
                    <span>Doctor, Thrissur</span>
                  </Col>
                </Row>
              </div>
