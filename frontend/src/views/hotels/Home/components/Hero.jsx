        ...
        <Row className="g-4 g-lg-5">
          <Col lg={6} className="position-relative mb-4 mb-md-0">
            ...
            <div className="hstack gap-4 flex-wrap align-items-center">
              <a href="/hotels/grid">
                <button className="btn btn-primary-soft mb-0">Book Now</button>
              </a>
              <GlightBox
                data-glightbox
          ...
          <Col lg={6} className="position-relative">
            <Image
              src="https://res.cloudinary.com/danenxaul/image/upload/v1771707138/luxury-architecture-exterior-design_1_1_gtahbh.webp"
              className="rounded"
            />
            ...
            <div className="vstack gap-5 align-items-center position-absolute top-0 start-0 d-none d-md-flex mt-4 ms-n3">
              <img
                ...
                src="https://res.cloudinary.com/djnaor5ed/image/upload/v1771746627/interior-decoration-inspired-by-mexican-folklore_1_hwh8hk.webp"
                alt="avatar"
              />
              <img
                className="icon-xl shadow-lg border border-3 border-white rounded-circle"
                src="https://res.cloudinary.com/djnaor5ed/image/upload/v1771746626/luxury-bedroom-hotel_1_c0xww0.webp"
                alt="avatar"
              />
            </div>
          </Col>
