...
const UpdatePassword = () => {
  ...
  return <Card className="border">
      ...
      <form onSubmit={handleSubmit(() => {})} className="card-body">
        <PasswordFormInput name="currentPassword" label="Current password" placeholder="Enter current password" containerClass="mb-3" control={control} />
        ...
        <PasswordFormInput name="confirmPassword" label="Confirm new password" placeholder="confirm new password" containerClass="mb-3" control={control} />
